...
public class ModeratorOrdersCallbackHandler implements AbstractHandler {
    ...
    public List<PartialBotApiMethod<?>> getAnswerList(BotApiObject botApiObject) {
        ...
        if (data.startsWith(Constants.KEYBOARD_MODERATOR_ORDER_BUTTON_ORDERS_COMMAND)) {
            orderId = Integer.parseInt(
                    data.replace(Constants.KEYBOARD_MODERATOR_ORDER_BUTTON_ORDERS_COMMAND, ""));
            moderatorOrderInfo = cacheService.get(chatId).getModeratorOrderInfo();
            moderatorOrderInfo.setOrderId(orderId);
//            sendMethod = moderatorOrderKeyboardMessage.prepareScrollingMessage(
//                    chatId, ScrollerType.NEW, ScrollerObjectType.ITEM);
//            answer.addAll(Utils.handleOptionalSendMessage(sendMethod, callbackQuery));
        } else {

            switch (data) {
                case Constants.KEYBOARD_MODERATOR_ORDER_BUTTON_CLOSE_COMMAND:

                    answer.add(Utils.prepareDeleteMessage(chatId, messageId));
                    break;

                case Constants.KEYBOARD_MODERATOR_ORDER_BUTTON_NEXT_COMMAND:
                ...
                case Constants.KEYBOARD_MODERATOR_ORDER_BUTTON_PREVIOUS_COMMAND:
                ...
                case Constants.KEYBOARD_MODERATOR_ORDER_BUTTON_CONFIRMED_COMMAND:
                ...
                case Constants.KEYBOARD_MODERATOR_ORDER_BUTTON_PAID_COMMAND:
                ...
                case Constants.KEYBOARD_MODERATOR_ORDER_BUTTON_PRINTING_COMMAND:
                ...
                case Constants.KEYBOARD_MODERATOR_ORDER_BUTTON_NEW_COMMAND:
                ...
                case Constants.KEYBOARD_MODERATOR_ORDER_BUTTON_CANCELED_COMMAND:
                ...
                case Constants.KEYBOARD_MODERATOR_ORDER_BUTTON_SHIPPED_COMMAND:
                ...
                case Constants.KEYBOARD_MODERATOR_ORDER_BUTTON_ALL_STATUSES_COMMAND:
    ...
    public List<String> getOperatedCallBackQuery() {
        return List.of(Constants.KEYBOARD_MODERATOR_ORDER_OPERATED_CALLBACK);
    }
}